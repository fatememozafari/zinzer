...
class GeoTechnicsController extends Controller
{
    ...
    public function completeRegisteStore(Request $request, Geotechnic $geotechnic)
    {
        ...
        $request->validate([
            ...
            'f_name' => 'نام مالک',
            'l_name' => 'نام خانوادگی مالک',
            'code_melli' => ' مالککد ملی',
            'mobile' => 'شماره تماس مالک',
            'address' => 'آدرس مالک',
            'registration_plate' => 'پلاک ثبتی مالک',
            'code' =>'کد تایید'
            ]);
    ...
    private function validateForm(Request $request)
    {
        $request->validate([
            ...
            '*.required' => 'فیلد :attribute الرامی است',
            '*.unique' => 'پرونده ای با این شماره ثبت موجود میباشد',
            'type_of_land.in' => 'مقدار فیلد صحیح نمیباشد',
            '*.in' => 'یکی از گزینه ها را انتخاب کنید',
            '*.gt' => 'مقدار :attribute باید بیشتر 0 باشد'
        ], [
            'map_registration_number' => 'شماره ثبت دستور نقشه',
            'total_building_area' => 'متراژ کل بنا',
            'type_of_land' => 'نوع زمین',
            'number_of_floors' => 'تعداد طبقات کل',
            'occupancy_level_downstairs' => 'سطح اشغال طبقه پایین',
            'number_of_underground_floors' => 'تعداد طبقات زیرزمین',
            'number_of_machine_boreholes' => 'تعداد گمانه ماشینی',
            'machine_bore_depth' => 'عمق گمانه ماشینی',
            'number_of_manual_wells' => 'تعداد چاهک دستی',
            'manual_well_depth' => 'عمق چاهک دستی',
            'guard_structure' => 'سازه نگهبان',
            'upload_and_cut_in_place' => 'بارگزاری و برش برجا',
            'in_well_vibration_test' => 'تست لرزه درون چاهی',
            'bedrock' =>'بستر سنگی',
            'drilling_surcharge' => 'اضافه بهای حفاری',
            'number_of_payment' => 'تعداد اقساط پرداخت',
            ]);
