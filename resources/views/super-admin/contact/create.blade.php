                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div style="padding-top: 50px">
                            <button type="button" class="btn btn-info waves-effect waves-light">جانمایی عکس جدید</button>
                        </div>
                    </div>


                    <div class="col-lg-6">
                        <div class="summernote">یبیب</div>
                        <div style="padding-top: 50px">
                            <button type="button" class="btn btn-info waves-effect waves-light"> ویرایش و ذخیره</button>
                        </div>
                    </div>
                </div>
            </div>
